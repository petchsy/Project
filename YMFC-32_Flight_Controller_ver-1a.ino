...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float pid_p_gain_roll = 2.3;               //Gain setting for the pitch and roll P-controller (default = 1.3).
float pid_i_gain_roll = 0.002;              //Gain setting for the pitch and roll I-controller (default = 0.04).
float pid_d_gain_roll = 40.0;              //Gain setting for the pitch and roll D-controller (default = 18.0).
int pid_max_roll = 280;                    //Maximum output of the PID-controller (+/-).
...
void setup() {
  ...
  //Serial.begin(115200);                                        //Set the serial output to 57600 kbps. (for debugging only)
...
void loop() {
  ...
  if (start == 2) {                                                                //The motors are started.
    ...
    if (esc_1 > 2000)esc_1 = 1800;                                                 //Limit the esc-1 pulse to 2000us.
    if (esc_2 > 2000)esc_2 = 1800;                                                 //Limit the esc-2 pulse to 2000us.
    if (esc_3 > 2000)esc_3 = 1800;                                                 //Limit the esc-3 pulse to 2000us.
    if (esc_4 > 2000)esc_4 = 1800;                                                 //Limit the esc-4 pulse to 2000us.
  }
